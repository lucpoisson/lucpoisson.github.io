...
Prior to joining Harvard, I received my PhD from [EPFL](https://www.epfl.ch/en/), where I was advised by [Florent Krzakala](https://florentkrzakala.com/). During my PhD I spent a few months as an ML research intern at [Aqemia](https://www.aqemia.com/), working on generative algorithms for structure-based drug discovery. Earlier, I took part in an [International MSc](http://www.pcs.polito.it/educational_tracks/international_track) program in Theoretical Physics delocalized in Paris, Trieste, and Turin.
{: .clear-float }
